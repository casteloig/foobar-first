...
type BarServiceClient interface {
	BarFunc(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *barServiceClient) BarFunc(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/proto.BarService/BarFunc", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BarServiceServer interface {
	BarFunc(context.Context, *Request) (*Response, error)
...
func (UnimplementedBarServiceServer) BarFunc(context.Context, *Request) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BarFunc not implemented")
}
...
func _BarService_BarFunc_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BarServiceServer).BarFunc(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.BarService/BarFunc",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BarServiceServer).BarFunc(ctx, req.(*Request))
	}
...
var BarService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.BarService",
	HandlerType: (*BarServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "BarFunc",
			Handler:    _BarService_BarFunc_Handler,
		},
	},
